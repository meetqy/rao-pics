...
export namespace Prisma {
  ...
  */
  ...
  > = S extends { select: any; include: any }
    ...
    ? {
        [P in TruthyKeys<S["select"]>]: P extends keyof ImageCountOutputType
          ? ImageCountOutputType[P]
          : never;
      }
    : ImageCountOutputType;
  ...
  export type TagCountOutputTypeGetPayload<S extends boolean | null | undefined | TagCountOutputTypeArgs> =
    S extends { select: any; include: any }
      ...
      ? {
          [P in TruthyKeys<S["select"]>]: P extends keyof TagCountOutputType ? TagCountOutputType[P] : never;
        }
      : TagCountOutputType;
  ...
  > = S extends { select: any; include: any }
    ...
    ? {
        [P in TruthyKeys<S["select"]>]: P extends keyof FolderCountOutputType
          ? FolderCountOutputType[P]
          : never;
      }
    : FolderCountOutputType;
  ...
  export type TagsGroupsCountOutputTypeGetPayload<
    S extends boolean | null | undefined | TagsGroupsCountOutputTypeArgs
  > = S extends { select: any; include: any }
    ? "Please either choose `select` or `include`"
    : S extends true
    ...
    ? {
        [P in TruthyKeys<S["select"]>]: P extends keyof TagsGroupsCountOutputType
          ? TagsGroupsCountOutputType[P]
          : never;
      }
    : TagsGroupsCountOutputType;
  ...
  export type ImageGetPayload<S extends boolean | null | undefined | ImageArgs> = S extends {
    select: any;
    include: any;
  }
    ? "Please either choose `select` or `include`"
    ...
    ? Image & {
        [P in TruthyKeys<S["include"]>]: P extends "folders"
          ? Array<FolderGetPayload<S["include"][P]>>
          : P extends "tags"
          ? Array<TagGetPayload<S["include"][P]>>
          : P extends "_count"
          ? ImageCountOutputTypeGetPayload<S["include"][P]>
          : never;
      }
    : S extends { select: any } & (ImageArgs | ImageFindManyArgs)
    ? {
        [P in TruthyKeys<S["select"]>]: P extends "folders"
          ? Array<FolderGetPayload<S["select"][P]>>
          : P extends "tags"
          ? Array<TagGetPayload<S["select"][P]>>
          : P extends "_count"
          ? ImageCountOutputTypeGetPayload<S["select"][P]>
          : P extends keyof Image
          ? Image[P]
          : never;
      }
    : Image;

  type ImageCountArgs = Omit<ImageFindManyArgs, "select" | "include"> & {
  ...
  > {
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, "findUnique", "Image"> extends True
      ? Prisma__ImageClient<ImageGetPayload<T>>
      : Prisma__ImageClient<ImageGetPayload<T> | null, null>;
     ...
     **/
    findFirst<
      T extends ImageFindFirstArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T["rejectOnNotFound"] : undefined
    >(
      args?: SelectSubset<T, ImageFindFirstArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, "findFirst", "Image"> extends True
      ? Prisma__ImageClient<ImageGetPayload<T>>
      : Prisma__ImageClient<ImageGetPayload<T> | null, null>;
  ...
  export class Prisma__ImageClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    ...
    folders<T extends Image$foldersArgs = {}>(
      args?: Subset<T, Image$foldersArgs>
    ): Prisma.PrismaPromise<Array<FolderGetPayload<T>> | Null>;

    tags<T extends Image$tagsArgs = {}>(
      args?: Subset<T, Image$tagsArgs>
    ): Prisma.PrismaPromise<Array<TagGetPayload<T>> | Null>;
  ...
  export type TagGetPayload<S extends boolean | null | undefined | TagArgs> = S extends {
    select: any;
    include: any;
  }
    ? "Please either choose `select` or `include`"
    ...
    ? Tag & {
        [P in TruthyKeys<S["include"]>]: P extends "tagsGroups"
          ? Array<TagsGroupsGetPayload<S["include"][P]>>
          : P extends "images"
          ? Array<ImageGetPayload<S["include"][P]>>
          : P extends "_count"
          ? TagCountOutputTypeGetPayload<S["include"][P]>
          : never;
      }
    : S extends { select: any } & (TagArgs | TagFindManyArgs)
    ? {
        [P in TruthyKeys<S["select"]>]: P extends "tagsGroups"
          ? Array<TagsGroupsGetPayload<S["select"][P]>>
          : P extends "images"
          ? Array<ImageGetPayload<S["select"][P]>>
          : P extends "_count"
          ? TagCountOutputTypeGetPayload<S["select"][P]>
          : P extends keyof Tag
          ? Tag[P]
          : never;
      }
  ...
  type TagCountArgs = Omit<TagFindManyArgs, "select" | "include"> & {
  ...
  > {
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, "findUnique", "Tag"> extends True
      ? Prisma__TagClient<TagGetPayload<T>>
      : Prisma__TagClient<TagGetPayload<T> | null, null>;
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, "findFirst", "Tag"> extends True
      ? Prisma__TagClient<TagGetPayload<T>>
      : Prisma__TagClient<TagGetPayload<T> | null, null>;
  ...
  export class Prisma__TagClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    ...
    tagsGroups<T extends Tag$tagsGroupsArgs = {}>(
      args?: Subset<T, Tag$tagsGroupsArgs>
    ): Prisma.PrismaPromise<Array<TagsGroupsGetPayload<T>> | Null>;

    images<T extends Tag$imagesArgs = {}>(
      args?: Subset<T, Tag$imagesArgs>
    ): Prisma.PrismaPromise<Array<ImageGetPayload<T>> | Null>;
  ...
  export type FolderGetPayload<S extends boolean | null | undefined | FolderArgs> = S extends {
    select: any;
    include: any;
  }
    ? "Please either choose `select` or `include`"
    ...
    ? Folder & {
        [P in TruthyKeys<S["include"]>]: P extends "images"
          ? Array<ImageGetPayload<S["include"][P]>>
          : P extends "_count"
          ? FolderCountOutputTypeGetPayload<S["include"][P]>
          : never;
      }
    : S extends { select: any } & (FolderArgs | FolderFindManyArgs)
    ? {
        [P in TruthyKeys<S["select"]>]: P extends "images"
          ? Array<ImageGetPayload<S["select"][P]>>
          : P extends "_count"
          ? FolderCountOutputTypeGetPayload<S["select"][P]>
          : P extends keyof Folder
          ? Folder[P]
          : never;
      }
    : Folder;

  type FolderCountArgs = Omit<FolderFindManyArgs, "select" | "include"> & {
  ...
  > {
     ...
     **/
    findUnique<
      T extends FolderFindUniqueArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T["rejectOnNotFound"] : undefined
    >(
      args: SelectSubset<T, FolderFindUniqueArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, "findUnique", "Folder"> extends True
      ? Prisma__FolderClient<FolderGetPayload<T>>
      : Prisma__FolderClient<FolderGetPayload<T> | null, null>;
     ...
     **/
    findFirst<
      T extends FolderFindFirstArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T["rejectOnNotFound"] : undefined
    >(
      args?: SelectSubset<T, FolderFindFirstArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, "findFirst", "Folder"> extends True
      ? Prisma__FolderClient<FolderGetPayload<T>>
      : Prisma__FolderClient<FolderGetPayload<T> | null, null>;
  ...
  export class Prisma__FolderClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    ...
    images<T extends Folder$imagesArgs = {}>(
      args?: Subset<T, Folder$imagesArgs>
    ): Prisma.PrismaPromise<Array<ImageGetPayload<T>> | Null>;
  ...
  export type TagsGroupsGetPayload<S extends boolean | null | undefined | TagsGroupsArgs> = S extends {
    select: any;
    include: any;
  }
    ? "Please either choose `select` or `include`"
    ...
    ? TagsGroups & {
        [P in TruthyKeys<S["include"]>]: P extends "tags"
          ? Array<TagGetPayload<S["include"][P]>>
          : P extends "_count"
          ? TagsGroupsCountOutputTypeGetPayload<S["include"][P]>
          : never;
      }
    : S extends { select: any } & (TagsGroupsArgs | TagsGroupsFindManyArgs)
    ? {
        [P in TruthyKeys<S["select"]>]: P extends "tags"
          ? Array<TagGetPayload<S["select"][P]>>
          : P extends "_count"
          ? TagsGroupsCountOutputTypeGetPayload<S["select"][P]>
          : P extends keyof TagsGroups
          ? TagsGroups[P]
          : never;
      }
    : TagsGroups;

  type TagsGroupsCountArgs = Omit<TagsGroupsFindManyArgs, "select" | "include"> & {
    select?: TagsGroupsCountAggregateInputType | true;
  };

  export interface TagsGroupsDelegate<
    GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined
  > {
    /**
     ...
     **/
    findUnique<
      T extends TagsGroupsFindUniqueArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T["rejectOnNotFound"] : undefined
    >(
      args: SelectSubset<T, TagsGroupsFindUniqueArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, "findUnique", "TagsGroups"> extends True
      ? Prisma__TagsGroupsClient<TagsGroupsGetPayload<T>>
      : Prisma__TagsGroupsClient<TagsGroupsGetPayload<T> | null, null>;
     ...
     **/
    findFirst<
      T extends TagsGroupsFindFirstArgs,
      LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T["rejectOnNotFound"] : undefined
    >(
      args?: SelectSubset<T, TagsGroupsFindFirstArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, "findFirst", "TagsGroups"> extends True
      ? Prisma__TagsGroupsClient<TagsGroupsGetPayload<T>>
      : Prisma__TagsGroupsClient<TagsGroupsGetPayload<T> | null, null>;
     ...
     * })
     **/
    aggregate<T extends TagsGroupsAggregateArgs>(
      args: Subset<T, TagsGroupsAggregateArgs>
    ): Prisma.PrismaPromise<GetTagsGroupsAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, TagsGroupsGroupByArgs, OrderByArg> & InputErrors
    ): {} extends InputErrors ? GetTagsGroupsGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
  }
  ...
  export class Prisma__TagsGroupsClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    ...
    tags<T extends TagsGroups$tagsArgs = {}>(
      args?: Subset<T, TagsGroups$tagsArgs>
    ): Prisma.PrismaPromise<Array<TagGetPayload<T>> | Null>;
  ...
  export type TagsGroupsScalarFieldEnum =
    (typeof TagsGroupsScalarFieldEnum)[keyof typeof TagsGroupsScalarFieldEnum];
  ...
  export type FolderCreateNestedManyWithoutImagesInput = {
    create?: XOR<
      Enumerable<FolderCreateWithoutImagesInput>,
      Enumerable<FolderUncheckedCreateWithoutImagesInput>
    >;
  ...
  export type TagsGroupsCreateNestedManyWithoutTagsInput = {
    create?: XOR<
      Enumerable<TagsGroupsCreateWithoutTagsInput>,
      Enumerable<TagsGroupsUncheckedCreateWithoutTagsInput>
    >;
  ...
  export type ImageCreateNestedManyWithoutFoldersInput = {
    create?: XOR<
      Enumerable<ImageCreateWithoutFoldersInput>,
      Enumerable<ImageUncheckedCreateWithoutFoldersInput>
    >;
  ...
  export type TagCreateNestedManyWithoutTagsGroupsInput = {
    create?: XOR<
      Enumerable<TagCreateWithoutTagsGroupsInput>,
      Enumerable<TagUncheckedCreateWithoutTagsGroupsInput>
    >;
